...
export default function Heading({expanedState, setTabState, pieConfig, setPieConfig}) {
    ...
    const handleChartHeadingVisible = (event) => {
        ...
        if (event.target.checked) {
            ...
            setSubHeadingText(headingText ? headingText : '')
            newConfig['title']['text'] = headingText ? headingText : '<span style="cursor:pointer;" id="custom-title">Chart Title</span>';
            newConfig['subtitle']['text'] = subHeadingText ? subHeadingText : '<span style="cursor:pointer;" id="custom-subtitle">Chart SubTitle</span>';
        } else {
                        ...
                        <div className={'customGridTitle'}>
                            <div className={'LeftTitle'}>
                                ...
                                <OutlinedInput
                                    ...
                                    disabled={headingVisible ? false : true}
                                    value={headingText}
                            ...
                            <div className={'settingToggle'}>
                                {
                                    Show ? <img src={SettingToggle} onClick={toggleSetting}/>
                                        :  headingVisible  ? <img src={SettingNotActive} onClick={headingVisible && toggleSetting}/> : <img src={SettingNotActive}/>
                                }
                            </div>
                        </div>
                    </Grid>
                            ...
                            <div className={'settingToggle'}>
                                {
                                    SubShow ? <img src={SettingToggle} onClick={subtoggleSetting}/>
                                        : headingVisible  ? <img src={SettingNotActive} onClick={headingVisible && subtoggleSetting}/> : <img src={SettingNotActive}/>
                                }
                            </div>
                        </div>
                    </Grid>
