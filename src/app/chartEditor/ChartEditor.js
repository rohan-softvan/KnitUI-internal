...
export default function ChartEditor(handleClick) {
  ...
  let applyButtonDisabledStatus = useSelector((state) => state.data.applyButtonDisabledStatus)
                  ...
                  <div className={'ChartSection'}>
                    ...
                    <div className={'mainChartBox'} style={{minHeight: '610px'}}>
                      ...
                      <Resizable
                          ...
                          handleStyles={{
                            bottomRight: (graphConfig && Object.keys(graphConfig).length > 0 || Object.keys(pieConfig).length > 0) ? {
