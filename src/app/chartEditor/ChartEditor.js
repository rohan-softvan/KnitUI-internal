...
import LineCharts from "../../assets/images/charteditor/LineChartNew.png";
...
export default function ChartEditor(handleClick) {
  ...
  let applyButtonDisabledStatus = useSelector(
    (state) => state.data.applyButtonDisabledStatus
  );
  ...
  const handleSetPieConfig = (config) => {
    ...
    if (config && Object.keys(config).length > 0) {
      const finalConfig = setDefaultEventsForGraph(
        config,
        selectedItems[0]?.measures[0]?.aggregation
      );
  ...
  const handleClose = (e) => {
    setOpen(false);
    dispatch(resetAllGraphConfigs());
    handleSetPieConfig({});
    subHandleChange(null, 0);
  };
  ...
  const setDefaultGraphProperties = (graphConfig) => {
    ...
    config.xAxis.title = {
      ...chartEditorEnum.xAxisDefaultProps.title,
      ...config.xAxis.title,
    };
    config.yAxis.title = {
      ...chartEditorEnum.yAxisDefaultProps.title,
      ...config.yAxis.title,
    };
  ...
  const handleChartChange = (type) => {
    let newConfig = JSON.parse(JSON.stringify(getGraphConfigs()));
    ...
    newConfig.chart["type"] = newChartType;
    dispatch(setGeneralChartType(newChartType));
    ...
    if (type === "multicolor-bar" || type === "multicolor-column") {
    ...
    <React.Fragment>
      ...
      >
        <Typography>
          ...
          <Button onClick={handleTooltipClose}>Okay!</Button>
        </Typography>
      </Popover>
      <ButtonComponent
      ...
      >
        <DialogTitle className={"chartEditorTitle"}>
          <div>
            ...
            <img src={GraphEditorIcon} className="barIcon" /> Graph Editor
          </div>
                ...
                <Box sx={{ width: "100%" }}>
                  ...
                  <div className={"InnerScrollTab"}>
                      ...
                      <div className="subTabs">
                        ...
                        <TabPanel value={subvalue} index={0}>
                          ...
                          <QuestionTab
                            tabValue={0}
                            pieConfig={pieConfig}
                            setPieConfig={handleSetPieConfig}
                          />
                        </TabPanel>
                        <TabPanel value={subvalue} index={1}>
                          <QuestionTab
                    ...
                    <TabPanel value={tabValue} index={1}>
                      <div className="subTabs">
                        <Typography className={"chooseChartTitle"}>
                          <img src={Appearance} /> Choose chart
                        </Typography>
                        <div className={"chartTypes"}>
                          <Accordion>
                            <AccordionSummary
                              ...
                              id="panel2a-header"
                            >
                              <Typography className="AccordTitle rootTitle">
                                <img src={BarChart} />
                                Bar charts
                              </Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                              <Grid container spacing={2}>
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    title={"Multicolor Bar Chart"}
                                    handleChartChange={() =>
                                      handleChartChange("multicolor-bar")
                                    }
                                    isSelected={
                                      chartType == "multicolor-bar"
                                        ? true
                                        : false
                                    }
                                    icon={MulticolorBar}
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    handleChartChange={() =>
                                      handleChartChange("stacked-bar")
                                    }
                                    isSelected={
                                      chartType == "stacked-bar" ? true : false
                                    }
                                    icon={StackedBarCharts}
                                    component={"export"}
                                  />
                                </Grid>
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    title={"Stacked Percent Bar Chart"}
                                    handleChartChange={() =>
                                      handleChartChange("stacked-percent-bar")
                                    }
                                    isSelected={
                                      chartType == "stacked-percent-bar"
                                        ? true
                                        : false
                                    }
                                    icon={PercentStackedBarChart}
                                    component={"export"}
                                  />
                                </Grid>
                              </Grid>
                              ...
                              <Grid container spacing={2}>
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    title={"Donut Chart"}
                                    handleChartChange={() =>
                                      handleChartChange("donut")
                                    }
                                    isSelected={
                                      chartType == "donut" ? true : false
                                    }
                                    icon={DonutChart}
                                    component={"export"}
                                  />
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    title={"3D Pie Chart"}
                                    handleChartChange={() =>
                                      handleChartChange("3d-pie")
                                    }
                                    isSelected={
                                      chartType == "3d-pie" ? true : false
                                    }
                                    icon={ThreeDPieChart}
                                    component={"export"}
                                  />
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    handleChartChange={() =>
                                      handleChartChange("3d-donut")
                                    }
                                    isSelected={
                                      chartType == "3d-donut" ? true : false
                                    }
                                    icon={ThreeDDonutChart}
                                    component={"export"}
                                  />
                                </Grid>
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    handleChartChange={() =>
                                      handleChartChange("semi-circle-donut")
                                    }
                                    isSelected={
                                      chartType == "semi-circle-donut"
                                        ? true
                                        : false
                                    }
                                    icon={ThreeDDonutChart}
                              ...
                              <Grid container spacing={2}>
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    title={"Basic Column"}
                                    handleChartChange={() =>
                                      handleChartChange("column")
                                    }
                                    isSelected={
                                      chartType == "column" ? true : false
                                    }
                                    icon={BasicColumn}
                                    component={"export"}
                                  />
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    title={"Multi-color Column"}
                                    handleChartChange={() =>
                                      handleChartChange("multicolor-column")
                                    }
                                    isSelected={
                                      chartType == "multicolor-column"
                                        ? true
                                        : false
                                    }
                                    icon={MultiColorColumn}
                                    component={"export"}
                                  />
                                </Grid>
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    handleChartChange={() =>
                                      handleChartChange("stacked-column")
                                    }
                                    isSelected={
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    isSelected={
                                      chartType == "stacked-percent-column"
                                        ? true
                                        : false
                                    }
                                    icon={StackedPercentColumn}
                                    component={"export"}
                                  />
                                </Grid>
                              </Grid>
                              ...
                              <Grid container spacing={2}>
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    title={"Scatter Chart"}
                                    handleChartChange={() =>
                                      handleChartChange("scatter")
                                    }
                                    isSelected={
                                      chartType == "scatter" ? true : false
                                    }
                                    icon={ScatterChart}
                                    component={"export"}
                                  />
                              ...
                              <Grid container spacing={2}>
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    handleChartChange={() =>
                                      handleChartChange("area")
                                    }
                                    isSelected={
                                      chartType == "area" ? true : false
                                    }
                                    icon={BasicArea}
                                    component={"export"}
                                  />
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    handleChartChange={() =>
                                      handleChartChange("stacked-area")
                                    }
                                    isSelected={
                                      chartType == "stacked-area" ? true : false
                                    }
                                    icon={StackedArea}
                                    component={"export"}
                                  />
                                ...
                                <Grid item lg={6} md={6} sm={12} xs={12}>
                                  <ChartEditorTypeCard
                                    ...
                                    handleChartChange={() =>
                                      handleChartChange("stacked-percent-area")
                                    }
                                    isSelected={
                                      chartType == "stacked-percent-area"
                                        ? true
                                        : false
                                    }
                                    icon={StackedPercentageArea}
                                    component={"export"}
                                  />
                                </Grid>
                              </Grid>
                    ...
                    <TabPanel value={tabValue} index={3}>
                      <div className="subTabs exportTab">
                        <Typography className={"exportTitle"}>
                          Choose format:
                        </Typography>
                        <Grid container spacing={2}>
                          <Grid item lg={6} md={6} sm={12} xs={12}>
                            <ChartEditorTypeCard
                              title={
                                "Recommended for graphs with logos, illustrations, and charts"
                              }
                              handleChartChange={downloadPngBtn}
                              icon={ExportPng}
                              component={"export"}
                            />
                          </Grid>
                          <Grid item lg={6} md={6} sm={12} xs={12}>
                            <ChartEditorTypeCard
                              title={
                                "Recommended for graphs with photos or mixed media"
                              }
                              handleChartChange={exportJPG}
                              icon={ExportJpg}
                              component={"export"}
                            />
                          </Grid>
                          <Grid item lg={6} md={6} sm={12} xs={12}>
                            <ChartEditorTypeCard
                              title={
                                "Printer-friendly, use as a document or email to others."
                              }
                              handleChartChange={exportPDF}
                              icon={ExportPdf}
                              component={"export"}
                            />
                          </Grid>
                    ...
                    <Resizable
                      ...
                      handleStyles={{
                        bottomRight:
                          ...
                          Object.keys(pieConfig).length > 0
                            ? {
                                backgroundImage:
                                  "url(data:image/png;base64,)",
