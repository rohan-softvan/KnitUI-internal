...
class ErrorVerificationLinkExpire extends Component{
    handleRedirection=()=>{
            ...
            <Grid container spacing={1}>
                <Grid item xs={12} md={12} lg={12} sm={12}>
                    ...
                    <Typography variant={"h6"} component={"h6"} className={"error-rescued"}>
                        <span onClick={this.handleRedirectionSUp}>Click here to get a new one</span>
                    </Typography>

                    <Button onClick={this.handleRedirectionSUp} className={"gobackhome"}>Back to Signup</Button>
                </Grid>
            </Grid>
        )
    }
...
export default ErrorVerificationLinkExpire;
